exports.run = {
   ...
   async: async (m, {
      ...
      if (!text && !m.quoted) return client.reply(m.chat, Func.texted('bold', `Tag or reply target`), m)
      ...
      try {
         ...
         if (!users) return client.reply(m.chat, Func.texted('bold', `@${mention} udah keluar dari grup atau gaada orangnya.`), m)

exports.run = {
   ...
   async: async (m, {
      ...
      try {
         ...
         if (command == 'tiktok' || command == 'tt') return client.sendFile(m.chat, json.data.video, Func.filename('mp4'), `Jika ingin menjadi musik, reply video ini dengan caption #tomp3`, m)
